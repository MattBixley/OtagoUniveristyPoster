...
poster_height: "297mm" # height in inches of poster
poster_width: "420mm" # width in inches of poster
font_family: "palatino" # choose from typical latex fonts (example: "palatino")
font_size: "6pt" #please see github.com/brentthorne/posterdown for compatible options.

#---TITLE BOX OPTIONS---#
#ESSENTIALS
title: '\fontfamily{phv}\selectfont Otago University Default Landscape'
author: "Matt Bixley^1^ Author Two^2^"
affiliation: "^1^Department of Biochemistry, University of Otago; ^2^Deparment of Another Institution, Institution University"
#STYLE & FORMATTING
titlebox_bgcol: "00508F"  #Colour of the Title Box background
titlebox_bordercol: "f9c013" #Colour of the title Box border.
titlebox_shape: "all"
titlebox_borderwidth: "0.25cm"
title_textcol: "ffffff" #colour of title text
author_textcol: "1b1c20" # Colour of author text
...
logoleft_xshift: '1cm'
logoleft_yshift: '1cm'
logoright_name: 'Figures/oulogo'
logoright_width: '3cm'
logoright_xshift: '-1cm'
logoright_yshift: '1cm'
...
column_margins: "0.1cm" # Margin spacing for columns
...
sectitle_bgcol: "00508F" # Colour of the section title box
sectitle_bordercol: "f9c013" # Colour of the border around the section title box.
sectitle_borderwidth: "1mm" # Thicknes of the section title box border
...
```{r, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, results = 'asis',fig.height = 1.5, fig.width = 2.5, out.width = "50%", warning = FALSE, fig.align = 'center', message = FALSE, dev='cairo_pdf')
```
...
Welcome to `posterdown` ! This is my attempt to provide a semi-smooth workflow for those who wish to take their `RMarkdown` skills to the conference world. Many creature comforts from `RMarkdown` are available in this package such as `Markdown` section notation, figure captioning, and even citations like this one `citation` The rest of this example poster will show how you can insert typical conference poster features into your own document. 

# Study Site

Here is a map made to show the study site using `ggplot2`, `ggspatial`, and `sf` and you can even reference this with a hyperlink, this will take you to **Figure**. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
\vspace{1cm}
...
```{r, out.width='80%', fig.height=3.0, fig.cap='Using ggplot and patchwork to generate a layout of multiple plots in one figure. The iris dataset was used to generate (a) a line graph, (b) a scatterplot, and (c) a boxplot all together!'}
